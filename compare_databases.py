...
class CompareDatabases():
    ...
    def compare_databases(self):
        ...
        return tables_master_temp, temp_tables_missing_in_master, tables_current_temp, temp_tables_missing_in_current, tables_missing_in_current, master_yyyymmdd, current_yyyymmdd
